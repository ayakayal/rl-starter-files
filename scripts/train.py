...
def log_dict_csv(dict,is_first_log=False,default_model_name='dict'):
  with open(f'{default_model_name}.csv', 'a', newline='') as csv_file:
...
def main():
    ...
    if args.algo=="ppo_diayn" or args.algo=="ppo_diayn_debug":
    ...
    acmodel = ACModel(obs_space, envs[0].action_space, args.mem, args.text, use_diayn,args.num_skills)
    ...
    if args.algo == "a2c":
        ...
        algo = torch_ac.PPOAlgo(envs, acmodel, device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                                args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
                                args.optim_eps, args.clip_eps, args.epochs, args.batch_size, args.singleton_env, preprocess_obss)
        ...
        algo=torch_ac.A2CAlgoICM_inverse(envs, acmodel, device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                            args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
                            args.optim_alpha, args.optim_eps, preprocess_obss,args.ir_coef)
    elif args.algo=="a2c_state_count_single":
        algo=torch_ac.A2CAlgoStateCountSingle(envs, acmodel, device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                                args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
                                args.optim_alpha, args.optim_eps, preprocess_obss,args.ir_coef)
    elif args.algo=="a2c_diayn":
        algo=torch_ac.A2CAlgoDIAYN(envs, acmodel, device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                                args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
                                args.optim_alpha, args.optim_eps, preprocess_obss,args.ir_coef,args.num_skills)
        ...
        algo= torch_ac.PPOAlgoDIAYN(envs, acmodel, device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                                args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
                                args.optim_eps, args.clip_eps, args.epochs, args.batch_size, args.singleton_env,preprocess_obss,args.ir_coef, args.num_skills, args.disc_lr)
    elif args.algo=="ppo_diayn_debug":
        algo= torch_ac.PPOAlgoDIAYNDEBUG(envs, acmodel, device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                                args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
                                args.optim_eps, args.clip_eps, args.epochs, args.batch_size, preprocess_obss,args.ir_coef, args.num_skills, args.disc_lr)
        ...
        algo= torch_ac.PPOAlgoStateCount(envs, acmodel, device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                                args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
                                args.optim_eps, args.clip_eps, args.epochs, args.batch_size,args.singleton_env, preprocess_obss,args.ir_coef)
        ...
        algo= torch_ac.PPOAlgoICM(envs, acmodel, device, args.frames_per_proc, args.discount, args.lr, args.gae_lambda,
                                args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
                                args.optim_eps, args.clip_eps, args.epochs, args.batch_size, preprocess_obss,args.ir_coef)
    ...
    run = wandb.init(
        ...
        project="intrinsic_rewards_final",
    ...
    while num_frames < args.frames:
        ...
        if update % args.log_interval == 0:
            ...
            state_coverage=logs["state_coverage"]
            state_coverage_position=logs["state_coverage_position"]
            ...
            if args.algo== "ppo_state_count" or args.algo=="ppo_entropy":
            ...
            elif args.algo=="ppo_diayn" or args.algo=="ppo_diayn_debug":
...
#uncomment if you would like to plot heatmaps
    ...
    #uncomment for final heatmap
        # if num_frames % (2048*50)==0: #198656
        #     save_state_dict=logs["state_visitation_pos"]
        #     save_ir_dict=logs["ir_dict"]
        #     #print('dictionary',save_state_dict)
        #     log_dict_csv(save_state_dict,is_first_log,f'state_{default_model_name}')
        #     log_dict_csv(save_ir_dict,is_first_log,f'ir_{default_model_name}')
        #     is_first_log=False
