...
save_dir = "./storage/save_models_Doorkey_entropy"
...
for i, ir_coef in enumerate(ir_coefs):
    ...
    model_name = f"sim_E_{ir_coef}"
    
    # Define the command to run
    command = f"python3 -m scripts.train --algo a2c_entropy --env MiniGrid-DoorKey-8x8-v0 --model {model_name} --save-interval 10 --frames 100000 --entropy-coef=0 --procs=1 --frames-per-proc=32 --ir-coef={ir_coef}"
