...
# Convert each string to a tuple
    ...
    return new_matrix,max_matrix_dict #return new_matrix for RedBlue
...
def read_csv_and_retrieve(file_name,grid_rows,grid_cols):
    ...
    with open(file_name, 'r') as csv_file:
        ...
        matrix_dict1,max_matrix_dict1=process_row(97,rows_saved,grid_rows,grid_cols)
...
filenames_algos=['state_MiniGrid-RedBlueDoors-8x8-v0_ppo_seed10005_ir0.0_ent0.0005.csv']
global_max=0
grid_rows=16
grid_cols=16
clip=1
...
for filename in filenames_algos:
    matrix_dict,max_matrix_dict=read_csv_and_retrieve(filename,grid_rows,grid_cols)       
    plot_heatmap(matrix_dict,max_matrix_dict,f'heatmaps_trials/{filename}_t5.png')  #it was global max
